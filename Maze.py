...
class Maze:
    ...
    def _solve_r(self, i, j):
        ...
        # move left
        if (i - 1 >= 0 and
                self._cells[i][j].has_left_wall is False
        ...
        # move right
        if (i + 1 <= self._num_cols - 1 and
                self._cells[i][j].has_right_wall is False
                and self._cells[i + 1][j].visited is False):
            self._cells[i][j].draw_move(self._cells[i + 1][j], False)
            if self._solve_r(i + 1, j):
                return True
        ...
        # move up
        if (j - 1 >= 0 and
                self._cells[i][j].has_top_wall is False
        ...
        # move down
        if (j + 1 <= self._num_rows - 1 and
                self._cells[i][j].has_bottom_wall is False
                and self._cells[i][j + 1].visited is False):
            self._cells[i][j].draw_move(self._cells[i][j + 1], False)
            if self._solve_r(i, j + 1):
                return True
